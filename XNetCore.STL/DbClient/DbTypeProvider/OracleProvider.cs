...
namespace XNetCore.STL
{
    ...
    /// MySql数据库操作
    /// </summary>
    internal class OracleProvider : IDbTypeProvider
    {

        private DbConfig dbConfig;
        public OracleProvider(DbConfig config)
        {
        ...
        {
            var type = Type.GetType("Oracle.ManagedDataAccess.Client.OracleClientFactory, Oracle.ManagedDataAccess", true, true);
